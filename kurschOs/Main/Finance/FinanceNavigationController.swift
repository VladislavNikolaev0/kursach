//
//  FinanceNavigationController.swift
//  kurschOs
//
...
final class FinanceNavigationController: NSViewController {
    ...
    private lazy var financeStartDateLable: NSTextField = {
    ...
    private func configure() {
        ...
        financeStartDateLable.stringValue = "\(finance.startDate!)"
    }
    
    private func setupHierarchy() {
        view.addSubview(financeStartDateLable)
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            financeStartDateLable.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            financeStartDateLable.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10),
