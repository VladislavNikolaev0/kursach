...
protocol FinanceTeamCellDelegate: AnyObject {
    func didSelectCell(_ cell: FinanceTeamCell)
}

final class FinanceTeamCell: NSView {
    
    weak var deleaget: FinanceTeamCellDelegate?
    ...
    init(teamName: String, type: String) {
        super.init(frame: .zero)
        
        self.name.stringValue += teamName
