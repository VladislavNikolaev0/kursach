//
//  CreateAnalitcTeamViewController.swift
//  kurschOs
//
...
final class CreateAnalitcTeamViewController: NSViewController {
    ...
    private func createButtonTapped() {
        ...
        if !teamNameTextField.stringValue.isEmpty &&
            ...
            guard let analitic else { return }
            
            TeamDataManager.shared.createTeamByAnalitic(
